...
export const CreatePlanModal: React.FC<CreatePlanModalProps> = ({ onClose, onSubmit }) => {
  const [formData, setFormData] = useState<CreatePlanData>({
    name: '',
    description: '',
    basePriceCents: 2900, // $29.00 default
    billingInterval: 'month',
    billingIntervalCount: 1,
    promoEnabled: false,
    promoDiscountPercent: 20,
    promoDurationMonths: 3,
    promoLabel: 'First 3 Months',
    promoDescription: 'Save 20% on your first quarter',
    displayOrder: 0,
    features: [
            ...
            {formData.promoEnabled && (
              <div className="p-3 rounded-md border border-orange-200 bg-white">
                {(() => {
                  ...
                  const intervalText = getIntervalLabel(formData.billingInterval, formData.billingIntervalCount || 1);
                  return (
