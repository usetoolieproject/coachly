  ...
  return (
    <div className="p-0 sm:p-4">
      ...
      <div className="mt-4 sm:mt-6 grid grid-cols-2 gap-3 sm:gap-4">
        <button
          type="button"
          className="flex items-center justify-center px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-xs sm:text-sm"
        >
        ...
        <button
          ...
          className="flex items-center justify-center px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-xs sm:text-sm"
        >
          <svg className="w-4 h-4 sm:w-6 sm:h-6 mr-1 sm:mr-2" viewBox="0 0 24 24" fill="currentColor">
